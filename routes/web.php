...
Route::get('/get-payment-gateways/{country_id}/{currency_id}/{option?}', [App\Http\Controllers\Web\HomeController::class, 'getPaymentGatways'])->name('payment-gateways.list');
