...
<html>
  <head>
    ...
    <title>Payment for Healing Streams</title>
    <style>
      /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <p>Kindly find the payment link for your <b>
                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="{{route('email.payment',[$payment->id,$payment->choice])}}" target="_blank">Pay</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <p>Our parayer is that you will always experience great joy with an abuntant supply from the Lord God Almighty. Amen.</p>
