 ...
 <!-- Header
        ...
        <header id="header" class="bg-dark">
          ...
          <div class="header-row">
              ...
              <!-- Logo
              ============================= -->
              <div class="logo me-3"> <a class="d-flex" href="index.html" title="Payyed - HTML Template"><img src="images/logo.png" style="border-radius:10px;" alt="Payyed"/></a> </div>
              <!-- Logo end --> 
              </div>
